    ...
    {
        {
            ...
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_left,  complex<double>(-1.120616135e-10, +6.028809313e-12), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_long_right, complex<double>(+4.331680271e-11, +3.591794269e-11), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_para_left,  complex<double>(-4.175448069e-11, +1.648861130e-11), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_para_right, complex<double>(+5.965600678e-11, +3.600451511e-11), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_perp_left,  complex<double>(+4.352686602e-11, +5.331426847e-12), eps);
            TEST_CHECK_RELATIVE_ERROR_C(amps.a_perp_right, complex<double>(+9.326590159e-11, +1.117502611e-10), eps);
       }
