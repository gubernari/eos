...
namespace eos
{
    ...
    {
        class Naive :
            public NonlocalCorrelator<nc::PToV>
        {
            public:
                ...
                static NonlocalCorrelatorPtr<nc::PToV> make(const Parameters & p, const Options & o)
                {
                    return NonlocalCorrelatorPtr<nc::PToV>(new Naive(p, o));
                }
        ...
        /*
         * Calculates the QCD-improved factorisation results for the correlator
            ...
            public NonlocalCorrelator<nc::PToV>
        {
            public:
                ...
                static NonlocalCorrelatorPtr<nc::PToV> make(const Parameters & p, const Options & o)
                {
                    return NonlocalCorrelatorPtr<nc::PToV>(new QCDF(p, o));
                }
            ...
            public NonlocalCorrelator<nc::PToV>
        {
            ...
            public:
                ...
                static NonlocalCorrelatorPtr<nc::PToV> make(const Parameters & p, const Options & o)
                {
                    return NonlocalCorrelatorPtr<nc::PToV>(new LCSR(p, o));
                }
...
//
                static NonlocalCorrelatorPtr<nc::PToV> make(const Parameters & p, const Options & o)
                {
                    return NonlocalCorrelatorPtr<nc::PToV>(new GvDV2019<Process_>(p, o));
                }
    ...
    NonlocalCorrelatorPtr<nc::PToV>
    NonlocalCorrelator<nc::PToV>::make(const QualifiedName & name, const Parameters & p, const Options & o)
    {
        typedef QualifiedName KeyType;
        typedef std::function<NonlocalCorrelatorPtr<nc::PToV> (const Parameters &, const Options &)> ValueType;
        ...
        if (entries.end() == i)
        {
            return NonlocalCorrelatorPtr<nc::PToV>(nullptr);
        }
    ...
    template <typename Process_>
    struct Implementation<NonlocalCorrelatorObservable<Process_, nc::PToV>>
    {
        NameOption opt_correlator;
        NonlocalCorrelatorPtr<nc::PToV> nc;

        Implementation(const Parameters & p, const Options & o) :
            opt_correlator(o, "correlator", qnp::Name("GvDV2019")),
            nc(NonlocalCorrelator<nc::PToV>::make(QualifiedName(qnp::Prefix(Process_::prefix), opt_correlator.value()), p, o))
        {
        }
    ...
    template <typename Process_>
    NonlocalCorrelatorObservable<Process_, nc::PToV>::NonlocalCorrelatorObservable(const Parameters & p, const Options & o) :
        PrivateImplementationPattern<NonlocalCorrelatorObservable<Process_, nc::PToV>>(new Implementation<NonlocalCorrelatorObservable<Process_, nc::PToV>>(p, o))
    {
    }

    template <typename Process_>
    NonlocalCorrelatorObservable<Process_, nc::PToV>::~NonlocalCorrelatorObservable() = default;

    template <typename Process_>
    double
    NonlocalCorrelatorObservable<Process_, nc::PToV>::re_H_perp(const double & q2) const
    {
    ...
    template <typename Process_>
    double
    NonlocalCorrelatorObservable<Process_, nc::PToV>::re_H_para(const double & q2) const
    {
    ...
    template <typename Process_>
    double
    NonlocalCorrelatorObservable<Process_, nc::PToV>::re_H_long(const double & q2) const
    {
    ...
    template <typename Process_>
    double
    NonlocalCorrelatorObservable<Process_, nc::PToV>::re_normalized_moment_V1(const double & q2) const
    {
    ...
    template <typename Process_>
    double
    NonlocalCorrelatorObservable<Process_, nc::PToV>::re_normalized_moment_V2(const double & q2) const
    {
    ...
    template <typename Process_>
    double
    NonlocalCorrelatorObservable<Process_, nc::PToV>::re_normalized_moment_V23(const double & q2) const
    {
