...
namespace eos
{
    ...
    BToKstarDileptonAmplitudes<tag::BCvDV2016>::BToKstarDileptonAmplitudes(const Parameters & p, const Options & o) :
        ...
        q(o, "q", { "d", "u" }, "d"),
        correlator(o, "correlator", { "BCvDV2016ModelA", "BCvDV2016ModelB", "naive" }, "BCvDV2016ModelA"),
     ...
     *    which are captured by the nonlocal correlator
    ...
    BToKstarDileptonAmplitudes<tag::BCvDV2016>::amplitudes(const double & s) const
    {
        ...
        const complex<double>
                calH_perp = nonlocal_correlator->H_perp(s),
                calH_para = nonlocal_correlator->H_para(s),
                calH_long = nonlocal_correlator->H_long(s);
