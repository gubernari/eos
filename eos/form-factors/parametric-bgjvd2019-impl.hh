...
namespace eos
{
        ...
        _m_P(p[Process_::name_P], *static_cast<ParameterUser *>(this))
    {
        ...
        (
            std::string("HQETFormFactors<") + Process_::name_B + "->" + Process_::name_P + ",PToP>",
            ll_warning,
        ...
        _m_V(p[Process_::name_V], *static_cast<ParameterUser *>(this))
    {
        ...
        (
            std::string("HQETFormFactors<") + Process_::name_B + "->" + Process_::name_V + ",PToV>",
            ll_warning,
            "This form factor parametrization is not a general one and requires careful attention. "
            "By default, it returns zeros for all form factors."
        );
        ...
        _m_P(p[Process_::name_P], *static_cast<ParameterUser *>(this))
    {
        ...
        (
            std::string("HQETFormFactors<") + Process_::name_Bst + "->" + Process_::name_P + ",VToP>",
            ll_warning,
            "This form factor parametrization is not a general one and requires careful attention. "
            "By default, it returns zeros for all form factors."
        );
        ...
        HQETFormFactorBase(p, o, Process_::hqe_prefix)
    {
        ...
        (
            std::string("HQETFormFactors<") + Process_::name_Bst + "->" + Process_::name_V + ",VToV>",
            ll_warning,
            "This form factor parametrization is not a general one and requires careful attention. "
            "By default, it returns zeros for all form factors."
        );
