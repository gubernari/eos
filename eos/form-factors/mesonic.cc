...
namespace eos
{
    ...
    FormFactorFactory<PToV>::form_factors
    {
        ...
        { "B->D^*::BFW2010",      &BFW2010FormFactors<BToDstar,   PToV>::make         },
        ...
        { "B_s->D_s^*::BFW2010",  &BFW2010FormFactors<BsToDsstar, PToV>::make         },
    ...
    FormFactorFactory<PToP>::form_factors
    {
        ...
        { "B_s->D_s::BFW2010",   &BFW2010FormFactors<BsToDs, PToP>::make                                                                                   },
        // c -> d
