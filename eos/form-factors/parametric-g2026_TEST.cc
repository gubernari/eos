    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                p["B->pi::s0V@G2026"]     =  20.170454;
                p["B->pi::sV@G2026"]      =  29.311396;
                p["B->pi::Q2@G2026"]      =  0.0;
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                p["B_s->K::s0V@G2026"]    =  15.264615;
                p["B_s->K::sV@G2026"]     =  29.311396;
                ...
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_V0(),       0.00264205, eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_A0(),       0,          eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_A1(),       0,          eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_V1(),       0.0005,     eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_T1(),       0.0025,     eps);
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                p["B_s->K^*::s0V@G2026"]      =  11.785640;
                p["B_s->K^*::s0A@G2026"]      =  11.785640;
                p["B_s->K^*::sV@G2026"]       =  29.311396;
                p["B_s->K^*::sA@G2026"]       =  29.811600;
                p["B_s->K^*::Q2@G2026"]       =  0.0;
                ...
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_A1(),  0.0094409,  eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_V1(),  0.0005,     eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_T1(),  0.0113,     eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_AT1(), 0.0191505,  eps);
            }
        }
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                p["B->K^*::s0V@G2026"]     =  11.299192;
                p["B->K^*::s0A@G2026"]     =  11.299192;
                p["B->K^*::sV@G2026"]      =  30.272004;
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                // Optimized s0A = s0V = s_th * (1 - sqrt(1 - s_- / s_th))
                p["B_s->phi::s0V@G2026"]     =  10.906048;
                p["B_s->phi::s0A@G2026"]     =  10.906048;
                p["B_s->phi::sV@G2026"]      =  30.272004;
                p["B_s->phi::sA@G2026"]      =  31.775769;
                ...
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_V0(),  0,         eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_A0(),  0.005,     eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_A1(),  0.0171064, eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_V1(),  0.0014,    eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_T1(),  0.0194,    eps);
                TEST_CHECK_NEARLY_EQUAL( ff.saturation_AT1(), 0.0407473, eps);
            }
        }
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                p["B->D^*::s0V@G2026"]      =  5.6540972;
                p["B->D^*::s0A@G2026"]      =  5.6540972;
                p["B->D^*::sV@G2026"]       =  41.075281;
    ...
    public:
        ...
        virtual void run() const
        {
...

            {
                ...
                p["B_s->D_s^*::s0V@G2026"]  =  5.5753758;
                p["B_s->D_s^*::s0A@G2026"]  =  5.5753758;
                p["B_s->D_s^*::sV@G2026"]   =  41.075281;
                ...
                p_endpoint["B_s->D_s^*::s0V@G2026"] = 5.6918798;
                p_endpoint["B_s->D_s^*::s0A@G2026"] = 5.6842827;
