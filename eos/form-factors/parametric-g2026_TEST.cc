...
class G2026FormFactorsTest :
    public TestCase
{
    public:
        G2026FormFactorsTest() :
            TestCase("G2026_form_factor_test")
        {
        }
        ...
        virtual void run() const
        {
            ...
            /* B -> D^* FFs */
            {
                ...
                p["B->D^*::a^g_0@G2026"] = 0.1e-02;
                p["B->D^*::a^g_1@G2026"] = 0.2e-02;
                p["B->D^*::a^g_2@G2026"] = 0.3e-02;
                p["B->D^*::a^g_3@G2026"] = 0.4e-02;

                p["B->D^*::a^f_0@G2026"] = 0.1e-02;
                p["B->D^*::a^f_1@G2026"] = 0.2e-02;
                p["B->D^*::a^f_2@G2026"] = 0.3e-02;
                p["B->D^*::a^f_3@G2026"] = 0.4e-02;

                /* F1_0 parameter determined by identity F1(t_-) = (mB - mV) * f(t_-) */
                p["B->D^*::a^F1_1@G2026"] = 0.2e-02;
                ...
                p["B->D^*::a^T1_2@G2026"] = 0.3e-02;
                p["B->D^*::a^T1_3@G2026"] = 0.4e-02;

                /* a_T2_0 determined from T1(0) = T2(0) */
                p["B->D^*::a^T2_1@G2026"] = 0.2e-02;
                p["B->D^*::a^T2_2@G2026"] = 0.3e-02;
                p["B->D^*::a^T2_3@G2026"] = 0.4e-02;

                /* a_T23_0 determined from T2(t_-) = 8 mB mV^2 / ((mB + mV) * (mB^2 + 3 mV^2 - t_-)) T23(t_-) */
                p["B->D^*::a^T23_1@G2026"] = 0.2e-02;
                p["B->D^*::a^T23_2@G2026"] = 0.3e-02;
                p["B->D^*::a^T23_3@G2026"] = 0.4e-02;
                ...
                p["B->D^*::a^g_0@G2026"] = 0.4e-02;
                p["B->D^*::a^g_1@G2026"] = 0.3e-02;
                p["B->D^*::a^g_2@G2026"] = 0.2e-02;
                p["B->D^*::a^g_3@G2026"] = 0.1e-02;

                p["B->D^*::a^f_0@G2026"] = 0.4e-02;
                p["B->D^*::a^f_1@G2026"] = 0.3e-02;
                p["B->D^*::a^f_2@G2026"] = 0.2e-02;
                p["B->D^*::a^f_3@G2026"] = 0.1e-02;

                /* F1_0 parameter determined by identity F1(t_-) = (mB - mV) * f(t_-) */
                p["B->D^*::a^F1_0@G2026"] = 0.4e-02;
                p["B->D^*::a^F1_1@G2026"] = 0.3e-02;
                ...
                p["B->D^*::a^T1_2@G2026"] = 0.2e-02;
                p["B->D^*::a^T1_3@G2026"] = 0.1e-02;

                /* a_T2_0 determined from T1(0) = T2(0) */
                p["B->D^*::a^T2_1@G2026"] = 0.3e-02;
                p["B->D^*::a^T2_2@G2026"] = 0.2e-02;
                p["B->D^*::a^T2_3@G2026"] = 0.1e-02;

                /* a_T23_0 determined from T2(t_-) = 8 mB mV^2 / ((mB + mV) * (mB^2 + 3 mV^2 - t_-)) T23(t_-) */
                p["B->D^*::a^T23_1@G2026"] = 0.3e-02;
                p["B->D^*::a^T23_2@G2026"] = 0.2e-02;
                p["B->D^*::a^T23_3@G2026"] = 0.1e-02;
            ...
            /* B -> D FFs*/
            {
                ...
                p["B->D::a^f+_0@G2026"] = 0.1e-02;
                p["B->D::a^f+_1@G2026"] = 0.2e-02;
                p["B->D::a^f+_2@G2026"] = 0.3e-02;
                p["B->D::a^f+_3@G2026"] = 0.4e-02;

                p["B->D::a^f0_0@G2026"] = 0.1e-02;
                p["B->D::a^f0_1@G2026"] = 0.2e-02;
                p["B->D::a^f0_2@G2026"] = 0.3e-02;
                p["B->D::a^f0_3@G2026"] = 0.4e-02;

                p["B->D::a^fT_0@G2026"] = 0.1e-02;
                p["B->D::a^fT_1@G2026"] = 0.2e-02;
                p["B->D::a^fT_2@G2026"] = 0.3e-02;
                p["B->D::a^fT_3@G2026"] = 0.4e-02;
                ...
                p["B->D::a^f+_0@G2026"] = 0.4e-02;
                p["B->D::a^f+_1@G2026"] = 0.3e-02;
                p["B->D::a^f+_2@G2026"] = 0.2e-02;
                p["B->D::a^f+_3@G2026"] = 0.1e-02;

                p["B->D::a^f0_0@G2026"] = 0.4e-02;
                p["B->D::a^f0_1@G2026"] = 0.3e-02;
                p["B->D::a^f0_2@G2026"] = 0.2e-02;
                p["B->D::a^f0_3@G2026"] = 0.1e-02;

                p["B->D::a^fT_0@G2026"] = 0.4e-02;
                p["B->D::a^fT_1@G2026"] = 0.3e-02;
                p["B->D::a^fT_2@G2026"] = 0.2e-02;
                p["B->D::a^fT_3@G2026"] = 0.1e-02;
            ...
            p["B->D::t_0@G2026"]  = 11.6213;
            p["B->D^*::t_0@G2026"] = 10.6844;
