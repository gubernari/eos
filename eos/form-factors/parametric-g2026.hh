...
namespace eos
{
        ...
        public virtual ParameterUser
    {
        public:
            ...
            UsedParameter sV, sA, s0V, s0A, Q2;
            ...
            G2026FormFactorTraits(const Parameters & p) :
                ...
                s0V(UsedParameter(p[std::string(Process_::label) + "::s0V@G2026"], *this)),
                s0A(UsedParameter(p[std::string(Process_::label) + "::s0A@G2026"], *this)),
