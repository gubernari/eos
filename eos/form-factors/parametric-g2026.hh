...
namespace eos
{
        ...
        public virtual ParameterUser
    {
        public:
            ...
            G2026FormFactorTraits(const Parameters & p, const Options & o, const std::vector<OptionSpecification> & options) :
                ...
                t_0(UsedParameter(p["B->D^*::t_0@G2026"], *this)),
        ...
        public FormFactors<PToV>
    {
        ...
        public:
            G2026FormFactors(const Parameters &, const Options &);
            ~G2026FormFactors();
