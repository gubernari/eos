...
namespace eos
{
    ...
    std::string G2026FormFactors<Process_, PToV>::_par_name(const std::string & ff_name)
    {
        return std::string("B->D^*") + std::string("::a^") + ff_name + std::string("@G2026");
    }

    template<typename Process_>
    G2026FormFactors<Process_, PToV>::G2026FormFactors(const Parameters & p, const Options & o) :
        ...
        _traits(G2026FormFactorTraits<Process_, PToV>(p, o, _options)),
        _mB(_traits.m_B),
        _mV(_traits.m_V),
        t_0(_traits.t_0)
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::_phi(const double & s, const double & s_0, const double & K, const unsigned & a, const unsigned & b,                                                 const unsigned & c, const double & chi) const
    {
    ...
    // Functions
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::g(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::a_F1_0() const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::F1(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::v(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::a_1(const double & s) const
    {
        return 1.0/(_mB + _mV) * f(s);
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::a_2(const double & s) const
    {
        return (_mB + _mV) / eos::lambda(power_of<2>(_mB), power_of<2>(_mV), s) * ((power_of<2>(_mB) - power_of<2>(_mV) - s) * f(s) - 2.0 * _mV * F1(s));
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::a_12(const double & s) const
    {
        return F1(s) / (8.0 * _mB * _mV);
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::t_1(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::a_T2_0() const
    {
        const double z = _traits._z(0.0, _traits.t_0, _traits.tp());
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::t_2(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::t_3(const double & s) const
    {
        return (
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::a_T23_0() const
    {
        const double z = _traits._z(_traits.tm(), _traits.t_0, _traits.tp());
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::t_23(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f_perp(const double & /*s*/) const
    {
        return 0.0;  //  TODO
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f_para(const double & /*s*/) const
    {
        return 0.0;  //  TODO
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f_long(const double & /*s*/) const
    {
        return 0.0;  //  TODO
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f_perp_T(const double & /*s*/) const
    {
        return 0.0;  //  TODO
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f_para_T(const double & /*s*/) const
    {
        return 0.0;  //  TODO
    }

    template<typename Process_>
    double G2026FormFactors<Process_, PToV>::f_long_T(const double & /*s*/) const
    {
        return 0.0;  //  TODO
    }
    ...
    template<typename Process_>
    const std::vector<OptionSpecification> G2026FormFactors<Process_, PToV>::_options
    {
    ...
    template<typename Process_>
    std::string G2026FormFactors<Process_, PToP>::_par_name(const std::string & ff_name)
    {
        return std::string("B->D") + std::string("::a^") + ff_name + std::string("@G2026");
    }

    template<typename Process_>
    G2026FormFactors<Process_, PToP>::G2026FormFactors(const Parameters & p, const Options & o) :
        ...
        _traits(G2026FormFactorTraits<Process_, PToP>(p, o, _options)),
        _mB(_traits.m_B),
        _mP(_traits.m_P),
        t_0(_traits.t_0)
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToP>::_phi(const double & s, const double & s_0, const double & K, const unsigned & a, const unsigned & b,                                                 const unsigned & c, const double & chi) const
    {
        const double sq_tp    = std::sqrt(_traits.tp());
        const double sq_tp_t  = std::sqrt(_traits.tp() - s);
        const double sq_tp_t0 = std::sqrt(_traits.tp() - s_0);
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToP>::f_p(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToP>::f_0(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToP>::f_t(const double & s) const
    {
    ...
    template<typename Process_>
    double G2026FormFactors<Process_, PToP>::f_plus_T(const double & /*s*/) const
    {
        return 0.0; //  TODO
    }
    ...
    template<typename Process_>
    const std::vector<OptionSpecification> G2026FormFactors<Process_, PToP>::_options
    {
        { "n-bound-states-1m"_ok, { "1"s, "2"s, "3"s, "4"s }, "3"s },
        { "n-bound-states-0p"_ok, { "1"s, "2"s             }, "2"s }
    };
